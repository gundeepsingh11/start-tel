...
var options = new function() {
  ...
  this.DIST_SRC = '../m-static/resources', // specific to spring-starter-project. change to suit your project needs.
  ...
  this.JS_DEST_NAME = 'm-app.min.js',
  
  this.CSS_DEST_NAME = 'm-app.min.css',
